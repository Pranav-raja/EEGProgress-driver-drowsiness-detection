...
class EEGProgress(nn.Module):  # New architecture
    def __init__(self, act_func):
        ...
        self.TEMP_Sequence1.add_module('T1-Conv1', nn.Conv2d(1, self.F1, (1, 2), stride=(1, 1)))
        ...
        self.FC1.add_module('E_FC1', nn.Linear(112, 18))
    ...
    def forward(self, source_L, source_R):
        ...
        # print(source_LR.shape)
        # if()
        source_LR = source_LR.reshape(source_LR.shape[0], 112)  # Adjust to a valid shape
